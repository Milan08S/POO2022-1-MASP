...
float Mayor13::calcularResultado(float gonzosApostar) {
 ...
 void Mayor13::mostrarReglas(){
    cout << "Mayor 13\n"
            "==========================\n"
            "• Mecánica de Juego\n"
            "El sistema genera un número aleatorio para el usuario entre 1 y 13. Ahí el usuario debe tener 2 opciones para continuar.\nLa primera: darse por perdido antes de que se genere el número que le corresponde a casino (en este caso perderá la mitad del dinero apostado).\nLa segunda: jugar, es decir, que se genere el número aleatorio del casino.\n"
            "\n"
            "• Calcular Resultado\n"
            "En caso de que el usuario saque un número menor o igual que el casino, perderá todo lo apostado. En otro caso, el usuario ganará el doble de lo apostado (es decir, apostado x 2)";
}